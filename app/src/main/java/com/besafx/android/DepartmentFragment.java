...
import com.besafx.android.adapter.DepartmentGridAdapter;
import com.besafx.android.entity.Department;
import com.besafx.android.task.GetDepartments;
...
public class DepartmentFragment extends Fragment {
    ...
    protected void readDepartments() {
        new GetDepartments(getContext(), new GetDepartments.OnAction() {
            @Override
            public void onGetSuccess(Department[] regions) {
                DepartmentGridAdapter regionGridAdapter = new DepartmentGridAdapter(getContext(), Lists.newArrayList(regions));
